...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.1.7/activejob/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.1.7/activejob" } if s.respond_to? :metadata=
