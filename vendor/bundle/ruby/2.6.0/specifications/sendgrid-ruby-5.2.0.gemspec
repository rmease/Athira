# -*- encoding: utf-8 -*-
# stub: sendgrid-ruby 5.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ruby_http_client>.freeze, ["~> 3.2"])
      s.add_runtime_dependency(%q<sinatra>.freeze, [">= 1.4.7", "< 3"])
      ...
      s.add_dependency(%q<ruby_http_client>.freeze, ["~> 3.2"])
