...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<xpath>.freeze, [">= 2.0", "< 4.0"])
      s.add_runtime_dependency(%q<addressable>.freeze, [">= 0"])
      s.add_development_dependency(%q<selenium-webdriver>.freeze, [">= 2.0", "< 4.0", "!= 3.4.1"])
      ...
      s.add_dependency(%q<xpath>.freeze, [">= 2.0", "< 4.0"])
      s.add_dependency(%q<addressable>.freeze, [">= 0"])
      s.add_dependency(%q<selenium-webdriver>.freeze, [">= 2.0", "< 4.0", "!= 3.4.1"])
