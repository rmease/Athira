...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.1.5/railties/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.1.5/railties" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<actionview>.freeze, ["= 5.1.5"])
    else
