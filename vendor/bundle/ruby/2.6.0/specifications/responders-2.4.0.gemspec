...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>.freeze, [">= 4.2.0", "< 5.3"])
      s.add_runtime_dependency(%q<actionpack>.freeze, [">= 4.2.0", "< 5.3"])
    else
      s.add_dependency(%q<railties>.freeze, [">= 4.2.0", "< 5.3"])
      s.add_dependency(%q<actionpack>.freeze, [">= 4.2.0", "< 5.3"])
    end
  else
    s.add_dependency(%q<railties>.freeze, [">= 4.2.0", "< 5.3"])
    s.add_dependency(%q<actionpack>.freeze, [">= 4.2.0", "< 5.3"])
