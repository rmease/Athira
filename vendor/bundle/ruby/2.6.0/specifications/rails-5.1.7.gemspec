...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionview>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<activerecord>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<activejob>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<actioncable>.freeze, ["= 5.1.7"])
      s.add_runtime_dependency(%q<railties>.freeze, ["= 5.1.7"])
      ...
      s.add_dependency(%q<actionview>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<activemodel>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<activerecord>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<actionmailer>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<activejob>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<actioncable>.freeze, ["= 5.1.7"])
      s.add_dependency(%q<railties>.freeze, ["= 5.1.7"])
